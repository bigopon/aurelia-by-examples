import { camelCase, DI, Registration } from '@aurelia/kernel';
import { BrowserPlatform } from '@aurelia/platform-browser';
import { bindable, customElement, CustomElement, customAttribute, IPlatform, StandardConfiguration, ColonPrefixedBindAttributePattern, Aurelia } from '@aurelia/runtime-html';
...
let ResolveValueConverter$1 = class ResolveValueConverter {
    constructor(loader) {
        this.loader = loader;
    }
...
ResolveValueConverter$1 = __decorate([
    valueConverter('resolve')
], ResolveValueConverter$1);
let ResultViewer$1 = class ResultViewer {
    constructor() {
        this.title = '';
        this.code = '';
        this.template = '';
...
__decorate([
    bindable
], ResultViewer$1.prototype, "title", void 0);
__decorate([
    bindable
], ResultViewer$1.prototype, "code", void 0);
__decorate([
    bindable
], ResultViewer$1.prototype, "template", void 0);
__decorate([
    bindable
], ResultViewer$1.prototype, "styles", void 0);
__decorate([
    bindable
], ResultViewer$1.prototype, "globals", void 0);
ResultViewer$1 = __decorate([
    customElement({
        name: 'result-viewer',
