...
export type AureliaExample = (IExample | IExampleHeading) & {
  indent?: number;
};

export const examples: AureliaExample[] = [
  // hello world section
  {
    id: 'basic',
    type: 'heading',
  ...
  },
  {
    ...
    desc:
      `There are contextual properties inside a repeat for:
...
4. Specify each option's value via the model property:
  ...
  },
  {
    ...
    desc:
      'You may run into situations where the objects in your view and view model may look the same, ' +
      'but are different objects. To support this scenario you can override Aurelia\'s default "matcher", ' +
      'which looks like this:\n(a, b) => a === b.',
  ...
  },
  {
    ...
    type: 'link',
    desc:
      'Use "ref" attribute on an element to express the property to assign the element reference to. ' +
  ...
  },
  {
    ...
    type: 'link',
    desc:
      'Use "view-model.ref" on a custom element to express the property to assign the element view model reference to. ' +
      'The value will be available after "binding" lifecycle, and before "bound" lifecycle',
  ...
  },
  {
    ...
    type: 'link',
    desc:
      'Use "xxxx.ref", where xxxx is the name of the attribute, on a custom element to express the property to assign a custom attribute view model reference to. ' +
      'The value will be available after "binding" lifecycle, and before "bound" lifecycle',
